...
<body x-data="" class="is-
er-blur" x-bind="$store.global.documentBody">
    <!-- Page Wrapper -->
                ...
                <div class="col-span-12 lg:col-span-8 xl:col-span-9">
                    <form action="{{ route('questions.store') }}" method="POST" class="space-y-6 bg-white dark:bg-navy-800 p-6 rounded-lg shadow-lg">
                        ...
                        <div class="space-y-2">
                            ...
                            <textarea  id="question_text" name="question_text" rows="10" maxlength="65535"
                            placeholder="Enter your question here. Be as detailed as possible." required class="block w-full px-4 py-2 text-slate-700 bg-white border border-slate-300 rounded-md shadow-sm focus:border-black focus:ring focus:ring-black focus:ring-opacity-50 dark:bg-navy-700 dark:border-navy-600 dark:text-navy-200 dark:focus:ring-navy-200"></textarea><br>
                            @error('question_text')
