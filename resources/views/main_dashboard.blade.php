        ...
        <div id="root" class="min-h-100vh flex grow bg-slate-50 dark:bg-navy-900">
                        ...
                        Tasks
                          ...
                          View All
                            ...
                            <div x-effect="if($store.global.isSearchbarActive) isShowPopper = false"
                                ...
                                <div :class="isShowPopper && 'show'" class="popper-root" x-ref="popperRoot"
                                    style="position: fixed; inset: 0px 0px auto auto; margin: 0px; transform: translate(15px, 58px);"
          ...
          <img src="backend/images/illustrations/help.svg" alt="image">
                    ...
                    <h2 class="mt-8 text-xl font-medium text-slate-600 dark:text-navy-100 lg:text-2xl">
                        Can't find what you're looking for on the search? Ask a question here. 
                    </h2>
